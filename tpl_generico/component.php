...
if ($paramsFontScheme) {
    if (stripos($paramsFontScheme, 'https://') === 0) {
        ...
        if (preg_match_all('/family=([^?:]*):/i', $paramsFontScheme, $matches) > 0) {
            $fontStyles = '--generico-font-family-body: "' . str_replace('+', ' ', $matches[1][0]) . '", sans-serif;
			--generico-font-family-headings: "' . str_replace('+', ' ', $matches[1][1] ?? $matches[1][0]) . '", sans-serif;
			--generico-font-weight-normal: 400;
			--generico-font-weight-headings: 700;';
        }
    } else {
...
// Enable assets
$wa->usePreset('template.generico.' . ($this->direction === 'rtl' ? 'rtl' : 'ltr'))
...
$wa->registerStyle('template.active', '', [], [], ['template.generico.' . ($this->direction === 'rtl' ? 'rtl' : 'ltr')]);
