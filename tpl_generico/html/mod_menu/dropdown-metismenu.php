...
$wa->registerAndUseScript('metismenu', 'media/templates/site/generico/js/mod_menu/menu-metismenu.min.js', [], ['defer' => true], ['metismenujs']);
...
<?php foreach ($list as $i => $item) {
    ...
    switch ($item->type) :
        ...
        case 'heading':
        case 'url':
            require_once ModuleHelper::getLayoutPath('mod_menu', 'dropdown-metismenu_' . $item->type);
            break;

        default:
            require_once ModuleHelper::getLayoutPath('mod_menu', 'dropdown-metismenu_url');
    endswitch;
